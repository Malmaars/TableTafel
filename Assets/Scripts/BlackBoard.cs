...
public static class BlackBoard
{
    ...
    public static List<ITile> waterTiles, grassTiles, sandTiles, snowTiles, wastelandTiles, bambooTiles, savannahTiles, sandWaterTiles, grassWaterTiles, tundraTiles, mixedTiles;
